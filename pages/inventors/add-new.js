                ...
                <div id='form-steps' className='text-[14px] bg-[#F3FBFA] mx-12 flex px-4 py-2 rounded-xl'>  
                    <div id="basic-info" className='flex flex-col gap-2 font-[400] justify-center items-center text-nowrap'>
                        <div className="icon" onClick={() => setStep(1)}>
                            <Image src="images/new-inventors-form/user-03.svg" alt="Basic Information Icon" width={20} height={20} />
                        </div>
                    ...
                    <div id="personal-info" className='flex flex-col gap-2 font-[400] justify-center items-center text-nowrap'>
                        <div className="icon"  onClick={() => setStep(2)}>
                            <Image src="images/new-inventors-form/briefcase.svg" alt="Professional Info Icon" width={20} height={20} />
                        </div>
                    ...
                    <div id="contact-info" className='flex flex-col gap-2 font-[400] justify-center items-center text-nowrap'>
                        <div className="icon" onClick={() => setStep(3)}>
                            <Image src="images/new-inventors-form/phone.svg" alt="Contact Information Icon" width={20} height={20} />
                        </div>
                    ...
                    <header className='flex justify-between'>
                        ...
                        <div id="nav" className='flex gap-3'>
                            ...
                            justify-between gap-4 text-[#4A4A4A] w-fit rounded-lg' onClick={goToLastStep}>
                                <Image src={"images/new-inventors-form/left-arrow.svg"} alt='left arrow' width={20} height={20} />
                                <span>Previous</span>
                            </div>
                            ...
                            transition-all duration-300 ease-out hover:scale-[104%] rounded-lg w-fit' onClick = {goToNextStep}>
                                <span>Next</span>
                                <Image src={"images/new-inventors-form/right-arrow.svg"} alt='right arrow' width={20} height={20} />
                            </div>): (
