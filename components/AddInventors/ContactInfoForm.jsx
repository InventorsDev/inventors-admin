...
const ContactInfoForm = ({ updateIsContactInfoFilled }) => {
    return (
        <div id='ContactInfoForm' className='flex w-full gap-6 mt-4'>
            <section id='section-1' className='flex flex-col w-full gap-4 mb-4'>
                <div id='inkedIn-div' className='label-input'>
                    <label htmlFor="linkedIn" className='text-[#29343D] text-sm'>LinkedIn Profile</label>
            ...
            <section id='section-2' className='flex flex-col w-full gap-4 mb-4'>
